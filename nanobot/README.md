...
One add-on in the [`niradler/ha-addons`](https://github.com/niradler/ha-addons)
repository. Runs [nanobot](https://github.com/niradler/nanobot) as a secured,
fully-configurable personal AI agent inside Home Assistant.
